...
// The `splice` method is used to modify the contents of an array by removing, replacing, or adding elements to it.
// The syntax for splice is: array.splice(start, deleteCount, item1, item2, ...)
// console.log(groceries.splice(1, 2)) // Removes 2 elements starting at index 1
// array is now ['🍎', '🍊'], removed is ['🍌', '🍐']


// The `slice` method is used to create a shallow copy of a portion of an array into a new array.
...
// // array is still ['🍌', '🍎', '🍊', '🍐'], sliced is ['🍎', '🍊']. so new array is ['🍎', '🍊']
...
// const numberOfLetters = ( word)=>{
//   console.log(word.length)
//  }
//  numberOfLetters('hi') //consoles 2

// const numberOfLetters = ( word)=>{
//   console.log(word.length)
//  }
//  numberOfLetters(prompt('word?'))
...
// doubleMap([1,2,3,4,5,6])

// // FILTER
// const fil = (array, greaterThan) => {
//   const result = array.filter((item)=>item>greaterThan)
//     return {result}
//   }
//   fil([1,2,3,4,5,6], 3) //👉 [4, 5, 6]
...
//basic synatax of resuce -> array.reduce(callback, initialValue);
// callback takes 4 types of values -> accumulator, currentValue, currentIndex, array
// in our case, to summ the networth, the syntax is ->  actors.reduce((accumulator, currentValue) => accumulator + currentValue, 0)
...
// console.log(result) //gives 10 as answer
